 ...
 */
function riversorgnz_menu_link(array $variables) {
  ...
  // rivers.org.nz: substitute home glyphicon instead of 'home' text.
  if ($href == '<front>') {
    if (isset($options['attributes']))  {
      $options['attributes']['class'] = array('glyphicon glyphicon-home');
    }
    else {
      $options['attributes'] = array('class' => array('glyphicon glyphicon-home'));
    }
    $title = '';
  }
